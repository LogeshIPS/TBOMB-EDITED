...
W='\033[0m'
# The Credit For This Code Goes To Dark Angel 
...
888    888  8888b.  888d888 888  888          d88P 888 88888b.   .d88b.   .d88b.  888 
888    888     "88b 888P"   888 .88P         d88P  888 888 "88b d88P"88b d8P  Y8b 888 
888    888 .d888888 888     888888K         d88P   888 888  888 888  888 88888888 888 
888  .d88P 888  888 888     888 "88b       d8888888888 888  888 Y88b 888 Y8b.     888 
8888888P"  "Y888888 888     888  888      d88P     888 888  888  "Y88888  "Y8888  888 
                                                                     888              
                                                                Y8b d88P              
                                                                 "Y88P"               
                                                                                     """
...
def checkinternet():
    ...
    if res:
        ...
        print('\t\tTBOMB-EDITED Will Stop Now...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("             Messages Sent           : ", requested)
        print("             Success                 : ", success)
        print("             Failure                 : ", failed)
        print("==================================================================")
        print("              Use this for fun, not for revenge !!                ")
        print("            This Bomber Was Created By Dark Angel !!              ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/Dark Angel/TBOMB-EDITED/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/Dak Angel/TBOMB-EDITED/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\n\t\t\tStarting TBOMB-EDITED...\n\n')
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/Dark Angel/TBOMB-EDITED/master/.notify").read().decode('utf-8')
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tTBOMB-EDITED Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
